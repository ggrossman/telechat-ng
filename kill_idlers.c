/*******************************************************************
 *
 * $Id: kill_idlers.c,v 1.4 2000/06/11 08:09:46 const Exp $
 * Utility to send SIGUSR1 signal to the chat daemon running on the
 * default port so that it will logout idle users.
 *
